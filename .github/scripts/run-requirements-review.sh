...
docs/REVIEW_HANDOFF.md, docs/REVIEW_EVIDENCE.md, docs/SOUSEI_LINE_IDENTITY.md,
README.md, and AGENTS.md / PRODUCT.md / DESIGN.md / QA.md when present.
Compare the exact PR request and diff with all applicable repository requirements.
Missing optional named documents are not by themselves an NG.
